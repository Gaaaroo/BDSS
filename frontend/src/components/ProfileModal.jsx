      ...
      {openProfile && (
        <>
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            ></div>
            {/* Modal content */}
            <div className="ml-64 relative inset-0 flex items-center justify-center z-50">
