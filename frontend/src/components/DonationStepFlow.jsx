...
const DonationStepFlow = ({ completedStepIndex }) => {
  return (
    <div className="flex flex-col items-center w-full max-w-3xl mx-auto bg-white">
      <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-rose-500 to-red-400 mb-5 text-center tracking-tight">
